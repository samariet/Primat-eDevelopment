...
write.table(prob_sp_1, file="pr1.txt")
write.table(prob_sp_2, file="pr2.txt")
write.table(prob_sp_3, file="pr3.txt")
write.table(prob_sp_4, file="pr4.txt")
write.table(prob_sp_5, file="pr5.txt")
